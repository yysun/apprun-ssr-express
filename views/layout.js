...
exports.default = (function (props, children) { return global.ssr ? apprun_1.default.createElement("html", null,
    apprun_1.default.createElement("head", null,
        ...
        apprun_1.default.createElement("title", null, "AppRun"),
    ...
    apprun_1.default.createElement("body", null,
                ...
                apprun_1.default.createElement("div", { className: "collapse navbar-collapse", id: "navbarSupportedContent" },
                    apprun_1.default.createElement("ul", { className: "navbar-nav mr-auto" },
                        apprun_1.default.createElement("li", { className: "nav-item active" },
                            apprun_1.default.createElement("a", { className: "nav-link", href: "#", onclick: "app.run('/', event, '/')" }, "Home")),
                        apprun_1.default.createElement("li", { className: "nav-item" },
                            apprun_1.default.createElement("a", { className: "nav-link", href: "#", onclick: "app.run('/', event, '/about')" }, "About")),
                        apprun_1.default.createElement("li", { className: "nav-item" },
                            apprun_1.default.createElement("a", { className: "nav-link", href: "#", onclick: "app.run('/', event, '/contact')" }, "Contact")),
        ...
        apprun_1.default.createElement("script", { src: "app.js" }))) : apprun_1.default.createElement("div", null, children || ''); });
